...
def rename(string):
    ...
    if string_list[0] == '__socketcall':
        string_list[2] = '__' + string_list[2]
    elif string_list[0] == '__noreturn':
        string_list[2] = '__' + string_list[2]
    elif string_list[0] == 'static':
        string_list[3] = '__' + string_list[3]
    else:
        string_list[1] = '__' + string_list[1]
